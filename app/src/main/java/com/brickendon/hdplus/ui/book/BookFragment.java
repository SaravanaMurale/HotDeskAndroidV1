package com.brickendon.hdplus.ui.book;
...
import com.brickendon.hdplus.adapter.ActiveTeamsAdapter;
import com.brickendon.hdplus.adapter.AssertListAdapter;
import com.brickendon.hdplus.adapter.BookingListToEditAdapter;
import com.brickendon.hdplus.adapter.CapacityAdapter;
import com.brickendon.hdplus.adapter.CarListToEditAdapterBooking;
...
import com.brickendon.hdplus.adapter.NewDeskListForEditRecyclerAdapter;
import com.brickendon.hdplus.adapter.NewDeskListRecyclerAdapter;
import com.brickendon.hdplus.adapter.ParkingSpotListRecyclerAdapter;
import com.brickendon.hdplus.adapter.ParticipantNameShowAdapter;
import com.brickendon.hdplus.adapter.RoomListRecyclerAdapter;
import com.brickendon.hdplus.adapter.ShowCountryAdapter;
import com.brickendon.hdplus.controllers.BookDeskController;
...
import com.brickendon.hdplus.databinding.FragmentBookBinding;
...
import com.brickendon.hdplus.model.AssertModel;
...
import com.brickendon.hdplus.utils.CalendarView;
import com.brickendon.hdplus.utils.CustomSpinner;
...
//                            ((MainActivity) getActivity()).getAddEditDesk("3",Utils.getISO8601format(date));
                        ...
                        Toast.makeText(getContext(), bookindata.getPastDate(), Toast.LENGTH_SHORT).show();
                } else{

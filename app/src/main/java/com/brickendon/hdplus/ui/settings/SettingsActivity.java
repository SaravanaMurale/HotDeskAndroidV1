...
import com.brickendon.hdplus.databinding.ActivitySettingsBinding;
...
import com.brickendon.hdplus.ui.wellbeing.NotificationActivity;
        ...
        try {
            for (int i=0; i<users.size(); i++) {
                if (users != null && users.size() > 0) {
                    final B2CUser selectedUser = users.get(i);

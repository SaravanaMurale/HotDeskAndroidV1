...
import com.brickendon.hdplus.ui.book.BookFragment;
...
public class NewDeskListForEditRecyclerAdapter extends RecyclerView.Adapter<NewDeskListForEditRecyclerAdapter.viewholder> implements Filterable {
        Context context;
        Activity activity;
        ...
        public NewDeskListForEditRecyclerAdapter.OnEDITChangeSelected onChangeSelected;
        BottomSheetDialog bottomSheetDialog;
        EditBookingDetails editBookingDetails;
        int typeId;
        String newEditStatus;
        public NewDeskListForEditRecyclerAdapter(Context context, NewDeskListForEditRecyclerAdapter.OnEDITChangeSelected onSelectSelected, FragmentActivity activity,
        ...
        public interface OnEDITChangeSelected{
            public void onEDITChangeDesk(int deskId, String deskName, String request,
        ...
        @NonNull
        @Override
        public NewDeskListForEditRecyclerAdapter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.new_desk_room_list_recycler_layout, parent, false);
            return new NewDeskListForEditRecyclerAdapter.viewholder(itemView);

        }

        @Override
        public void onBindViewHolder(@NonNull NewDeskListForEditRecyclerAdapter.viewholder holder, int position) {

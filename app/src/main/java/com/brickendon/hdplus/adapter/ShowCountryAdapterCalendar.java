...
public class ShowCountryAdapterCalendar extends RecyclerView.Adapter<ShowCountryAdapterCalendar.ShowCountryViewHolder> implements Filterable {
    ...
    public ShowCountryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_show_country_adapter,
                parent, false);
    ...
    public ShowCountryAdapterCalendar (Context context, List<LocateCountryRespose> countryList,
                                       OnSelectListener onSelectListener, String identifier) {

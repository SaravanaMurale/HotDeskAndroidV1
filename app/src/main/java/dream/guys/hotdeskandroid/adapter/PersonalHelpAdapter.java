...
public class PersonalHelpAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public PersonalHelpAdapter(Context mContext, List<WellbeingConfigResponse.Link> links) {

...
public class AdapterAdminNotificationReq extends RecyclerView.Adapter<AdapterAdminNotificationReq.viewHolder>{
    ...
    AccRejReqInterface accRejInterface;

    int cBoxPos = -1;
    int oldPos = -1;

    public AdapterAdminNotificationReq(Context context, ArrayList<IncomingRequestResponse.Result>
            notiList, String page, int cIncoming, int cOutGoing, AccRejReqInterface accRejInterface) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AdapterAdminNotificationReq.viewHolder(itemView);
    }
            ...
            public void onClick(View view) {
                ...
                if (notiList.get(pos).getEntityType()==3) {
                    ...
                    if (accRejInterface!=null){
                        accRejInterface.reqClickEvents(id,reqTeamId,entity, AppConstants.ACCEPT);
                    }
...
//                    int reqTeamId = notiList.get(pos).getRequestedTeamDeskId();
                    ...
                    if (accRejInterface!=null){
                        accRejInterface.reqClickEvents(id,0,entity, AppConstants.ACCEPT);
                    }
        ...
        holder.btnReject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (notiList.get(pos).getEntityType()==3){
                    ...
                    if (accRejInterface!=null){
                        accRejInterface.reqClickEvents(id,reqTeamId,entity, AppConstants.REJECT);
                    }
...
//                    int reqTeamId = notiList.get(pos).getRequestedTeamDeskId();
                    ...
                    if (accRejInterface!=null){
                        accRejInterface.reqClickEvents(id,0,entity, AppConstants.REJECT);
                    }
                } else if (notiList.get(pos).getEntityType()==4){
                    int id = notiList.get(pos).getId();
//                    int reqTeamId = notiList.get(pos).getRequestedTeamDeskId();
    ...
    public interface AccRejReqInterface{
